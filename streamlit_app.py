...
def getfruityvice(this_fruit_choice):
      ...
      funtion_output =   streamlit.dataframe (fruityvice_normalized)
      return funtion_output
    
# New Section to display fruits api response
...
#take the json version of the response and nomalize it
#fruityvice_normalized = pandas.json_normalize(fruityvice_response.json())
...
add_my_truit = streamlit.text_input('what fruit would you like to add?','jackfruit')
streamlit.write('Thanks for Adding',add_my_truit)
